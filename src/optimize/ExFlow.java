...
public abstract class ExFlow 
{
    ...
    public static interface Analysis {
         ...
         */
	DataflowObject getIn(Quad q, Quad pred);

	DataflowObject getAllIn(Quad q);

        /**
         * Get the output value of the quad.
         * @param q the quad to get the output of
         */
	DataflowObject getOut(Quad q, Quad succ);

	DataflowObject getAllOut(Quad q);
         ...
         */
	void setIn(Quad q, Quad pred, DataflowObject value);

	void setAllIn(Quad q, DataflowObject value);
         ...
         * @param value the value to set to the input of the quad
         */
	void setOut(Quad q, Quad succ, DataflowObject value);

	void setAllOut(Quad q, DataflowObject value);
